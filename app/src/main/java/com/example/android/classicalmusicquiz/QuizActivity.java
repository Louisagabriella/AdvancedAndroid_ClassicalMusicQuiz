...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Load the question mark as the background image until the user answer the question
    ...
    private void showNotification(PlaybackStateCompat state) {
        ...
        builder.setContentTitle(getString(R.string.guess)).
                ...
                setStyle(new NotificationCompat.MediaStyle().setMediaSession(mMediaSession.getSessionToken()).setShowActionsInCompactView(0, 1));
    ...
    public void onTracksChanged(TrackGroupArray tracksGroup, TrackSelectionArray trackSelection) {
